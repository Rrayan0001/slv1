...
const slides: Slide[] = [
  {
    id: 1,
        backgroundImage: "/landing_image.png",
  ...
  },
  {
    ...
    subtitle:
      "Professional cargo transportation nationwide. 18+ years of experience delivering excellence with 98% on-time delivery rate.",
  },
  {
    id: 3,
...
export default function Slideshow() {
  ...
  return (
    <div
      className="relative min-h-[70svh] sm:min-h-screen overflow-hidden slideshow-wrapper"
    ...
    >
      <div className="relative w-full h-[70svh] sm:h-screen slideshow-container">
        ...
        <div className="relative z-20 h-full flex items-end hero-content-overlay">
          <div className="w-full pl-4 pr-4 sm:pl-6 sm:pr-6 md:pl-[6%] md:pr-[6%] pb-4 sm:pb-8 md:pb-12 lg:pb-16 hero-content">
            <div className="flex flex-col sm:flex-row justify-between items-end gap-4 sm:gap-6 w-full">
              <div className="flex-1 max-w-xl sm:max-w-2xl">
                <AnimatePresence mode="wait">
                  <motion.h1
                    key={`headline-${activeSlide.id}-${currentSlide}`}
                  ...
                  >
                    <span style={{ color: "#ffffff" }}>{activeSlide.headlineWhite}</span>
                    <span style={{ color: "#2944F3" }}>{activeSlide.headlineBlue}</span>
                  </motion.h1>
                </AnimatePresence>
              </div>
              ...
              <div className="flex-1 max-w-xl sm:max-w-lg flex flex-col items-end sm:items-end">
                <AnimatePresence mode="wait">
                  <motion.p
                    key={`subtitle-${activeSlide.id}-${currentSlide}`}
            ...
            <div className="mt-4 sm:mt-6 flex w-full">
              <AnimatePresence mode="wait">
                <motion.a
                  key={`hero-cta-${currentSlide}`}
      ...
      <NavigationDots totalSlides={slides.length} currentSlide={currentSlide} onDotClick={goToSlide} />
